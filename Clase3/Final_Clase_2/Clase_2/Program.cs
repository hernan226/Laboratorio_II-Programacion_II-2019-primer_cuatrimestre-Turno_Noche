    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("4 - Mostrar resultado en binario");
                ...
                switch(key)
                {
                    case 1:
                        ...
                        int sbin = Conversor.BinarioEntero(Console.ReadLine());
                        Console.WriteLine(sbin);
                        calcu.Acumular(sbin.ToString());
                        Console.ReadKey();
                        break;
                    case 2:
                        ...
                        break;
                    case 3:
                        Console.WriteLine("Total: "+calcu.getResultadoEntero());
                        break;
                    case 4:
                        Console.WriteLine("Total en binario: "+calcu.getResultadoBinario());
                        break;
                    case 5:
                        continuar = false;
                        break;
